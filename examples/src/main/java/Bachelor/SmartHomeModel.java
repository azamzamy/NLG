...
public class SmartHomeModel {
	...
	private static final String file = "file:src/main/resources/data/art_rdf.owl";
		...
		for (OWLNamedIndividual ind : individuals) {
			...
			for (OWLAnnotationAssertionAxiom a : list) {
				...
				if (a.getValue() instanceof OWLLiteral) {
					...
					Set<Set<OWLAxiom>> exp2 = expGen.getInstanceExplanations(ind, romanticArtist, 10);
	...
	public static void main(String[] args) throws OWLOntologyCreationException, OWLException, IOException {
		SmartHomeModel app = new SmartHomeModel();
